...
const Profile = () => {
  ...
  return (
    <div className="flex">
      <div className="xl:ml-40 justify-center xl:justify-start flex items-center min-h-max flex-1 xl:border-r-2">
        {edit ? (
          <>
              ...
              <div className="flex border-2 rounded-lg flex-col md:flex-row">
                ...
                <div className="p-10 text-black">
                  <div>
                    ...
                    <div className="border lg:max-w-xl">
                      ...
                      <div className="relative ">
                        ...
                        <div
                          ...
                          id="visible"
                          className="absolute left-0 -bottom-[134px] hidden"
                        >
                    ...
                    <div className="mt-7" onClick={handleTableDelete}>
                      <label htmlFor="about" className="">
                        Write about yourself <span>(within 351 character)</span>
                        :
                      </label>
                      <textarea
                        ...
                        rows="5"
                      ></textarea>
                      <div className="flex justify-end">{word}/351</div>
                    </div>
                    <div
